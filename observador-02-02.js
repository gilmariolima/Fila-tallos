...
// @version      1.7.0
// @description  Lista operadores: verde = online, qualquer outra cor = offline (modal flutuante)
...
(function () {
    ...
    modal.innerHTML = `
        <div id="drag-handle" style="font-weight:bold;margin-bottom:8px;cursor:move;">
           Observador
        </div>
