...
(function () {
    ...
    const AGENTES_PERMITIDOS = [
        ...
        'Aline Simplicio','Marcus Luan', 'Tifane Sombra',
        'Caio Maciel', 'Ana Beatriz', 'Marcelo Augusto', 'Uelisson Torres',
        'Cayo Mendes', 'Pedro Santos', 'Kaio Leão', 'William Rodrigues',
        'André Lucas', 'Bruno Amancio', 'Lucas Sombra',
        'Aline Santos', 'Gilmário Lima', 'Nicole Silveira', 'Gleison Castro', 'Nayara Oliveira','Maria Rodrigues'
    ];
